...
<body>
    ...
    <nav>
        <ul>
            <li><a href="/bindex" class="animate__animated animate__fadeIn">Home</a></li>
            <li><a href="/bviewInfo" class="animate__animated animate__fadeIn">DashBoard</a></li>
            <li><a href="/blogout" class="animate__animated animate__fadeIn">Logout</a></li>
        </ul>
    </nav>
